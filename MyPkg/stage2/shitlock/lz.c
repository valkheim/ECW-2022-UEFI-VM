...
{
    FILE *in;
    in = fopen("stage2.efi", "r");
    if(in == NULL)
        return 0;
    printf("Original size: %ld\n", fsize(in));
    fclose(in);
    printf("Compressed: %u\n", file_lz77_compress("stage2.efi", "stage2.efi.c"));
    printf("Decompressed: %u", file_lz77_decompress("stage2.efi.c", "stage2.efi.d"));
    return 0;
}
